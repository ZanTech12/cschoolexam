...
const ReportCardsPrintView = () => {
  ...
  // ============================================
  const { data: termDetailsResponse } = useQuery({
    queryKey: ['term-details-for-print', termId],
    queryFn: () => termsAPI.getById(termId),
    enabled: !!termId,
    staleTime: 60000,
  });

  const printData = printResponse?.data || null;
  const termFullDetails = termDetailsResponse?.data || null;
  ...
  // ============================================
  const termStartDate = termFullDetails?.startDate || printData?.term?.startDate || null;
  ...
  const compactA4Styles = `
    ...
    .a4-document .comments-container { display: flex !important; grid-template-columns: unset !important; gap: 2mm !important; margin-bottom: 1mm !important; flex-shrink: 0 !important; }
    .a4-document .comment-box-elegant { border: 0.5px solid #555 !important; padding: 1.5mm 2mm !important; display: flex !important; flex-direction: column !important; flex: 1 !important; }
    ...
    .a4-document .footer-date-item { flex: 1; }
  ...
  const handlePrint = () => {
    ...
    const a4PrintStyles = `
      ...
      * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
      ...
      .a4-document .comments-container { display: flex !important; gap: 2mm !important; }
      .a4-document .comment-box-elegant { flex: 1 !important; display: flex !important; flex-direction: column !important; }
