...
const ReportCardsPrintView = () => {
  ...
  const compactA4Styles = `
    ...
    .a4-document .school-name {
      font-size: 11pt !important; margin: 0 !important; padding: 0 !important;
      letter-spacing: 0.5px !important; line-height: 1.2 !important;
    }
    .a4-document .doc-title {
      font-size: 7.5pt !important; margin: 0 !important; padding: 0 !important; line-height: 1.2 !important;
    }
    .a4-document .header-meta-box {
      display: flex !important; justify-content: center !important; align-items: center !important; gap: 3mm !important; margin-top: 0.5mm !important;
    }
    ...
    .a4-document .bio-grid {
      display: grid !important; grid-template-columns: 1fr 1fr 1fr 1fr !important;
      gap: 0 !important; border: 0.5px solid #555 !important; background: #555 !important;
    }
    ...
    .a4-document .grades-table-elegant {
      width: 100% !important; border-collapse: collapse !important; font-size: 7pt !important; table-layout: fixed !important;
    }
    .a4-document .grades-table-elegant th,
    .a4-document .grades-table-elegant td {
      padding: 0.8mm 1.5px !important; border: 0.5px solid #444 !important; line-height: 1.15 !important; vertical-align: middle !important;
    }
    ...
    .a4-document .psychomotor-table-compact td { padding: 0.5mm 1.5px !important; border: 0.5px solid #444 !important; line-height: 1.15 !important; vertical-align: middle !important; }
                  ...
                  <div className="attendance-section">
                    ...
                    <div className="attendance-grid">
                      <div className="attendance-card">
                        ...
                        <span className="attendance-value">{timesOpen !== '' ? timesOpen : '––––'}</span>
                      </div>
                      <div className="attendance-card">
